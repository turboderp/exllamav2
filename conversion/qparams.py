...
qparams_options = \
[
    # QParams(32, [4, 2], [0.05, 0.95], 4),
    # QParams(32, [6, 3, 2], [0.05, 0.1, 0.85], 4),
    # QParams(32, [6, 4, 3], [0.05, 0.1, 0.85], 4),
    # QParams(32, [6, 4], [0.05, 0.95], 4),
    # QParams(32, [6, 5, 4], [0.05, 0.1, 0.85], 4),
    # QParams(32, [6, 5], [0.05, 0.95], 4),
    # QParams(32, [6], [1.0], 4),
    # QParams(32, [8, 6], [0.05, 0.95], 4),
    # QParams(32, [8], [1.0], 4),

    # QParams(128, [2], [1.0], 4),
    QParams(32, [3, 2], [0.05, 0.95], 4),
    # QParams(16, [2], [1.0], 4),
    # QParams(16, [4, 2], [0.1, 0.9], 4),
    ...
    # QParams(32, [3, 2], [0.5, 0.5], 4),
    # QParams(32, [3], [1.0], 4),
    # QParams(32, [4, 3, 2], [0.1, 0.2, 0.7], 4),
    # QParams(32, [4, 3], [0.1, 0.9], 4),
    # QParams(32, [4, 3], [0.5, 0.5], 4),
    # QParams(32, [6, 3], [0.1, 0.9], 4),
    # QParams(128, [4], [1.0], 4),
    # QParams(32, [4], [1.0], 4),
    # QParams(16, [4], [1.0], 4),
