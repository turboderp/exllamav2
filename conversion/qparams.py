...
[
    ...
    QParams(128, [2], [1], 4),
    QParams(256, [2], [1], 4),
    QParams([32, 16], [3, 2], [0.05, 0.95], 4),
    QParams(32, [3, 2], [0.05, 0.95], 4),
    QParams(64, [3, 2], [0.05, 0.95], 4),
    QParams(128, [3, 2], [0.05, 0.95], 4),
    QParams(256, [3, 2], [0.05, 0.95], 4),
    QParams([32, 16], [3, 2], [0.1, 0.9], 4),
    QParams(32, [3, 2], [0.1, 0.9], 4),
    QParams(64, [3, 2], [0.1, 0.9], 4),
    QParams(128, [3, 2], [0.1, 0.9], 4),
    QParams(256, [3, 2], [0.1, 0.9], 4),
    QParams([32, 16], [3, 2], [0.25, 0.75], 4),
    QParams(32, [3, 2], [0.25, 0.75], 4),
    QParams(64, [3, 2], [0.25, 0.75], 4),
    QParams(128, [3, 2], [0.25, 0.75], 4),
    QParams(256, [3, 2], [0.25, 0.75], 4),
    QParams([32, 16], [4, 2], [0.1, 0.9], 4),
    QParams(32, [4, 2], [0.1, 0.9], 4),
    QParams(64, [4, 2], [0.1, 0.9], 4),
    QParams(128, [4, 2], [0.1, 0.9], 4),
    QParams(256, [4, 2], [0.1, 0.9], 4),
    QParams(32, [4, 2], [0.25, 0.75], 4),
    QParams(64, [4, 2], [0.25, 0.75], 4),
    QParams(128, [4, 2], [0.25, 0.75], 4),
    QParams(256, [4, 2], [0.25, 0.75], 4),
    QParams(32, [4, 3], [0.1, 0.9], 4),
    QParams(64, [4, 3], [0.1, 0.9], 4),
    QParams(128, [4, 3], [0.1, 0.9], 4),
    QParams(256, [4, 3], [0.1, 0.9], 4),
    QParams(32, [4, 3], [0.25, 0.75], 4),
    QParams(64, [4, 3], [0.25, 0.75], 4),
    QParams(128, [4, 3], [0.25, 0.75], 4),
    QParams(256, [4, 3], [0.25, 0.75], 4),
    QParams(32, [4], [1], 4),
    QParams(64, [4], [1], 4),
    QParams(128, [4], [1], 4),
    QParams(256, [4], [1], 4),
    ...
    QParams(256, [5, 4], [0.1, 0.9], 4),
    QParams(32, [5, 4], [0.25, 0.75], 4),
    QParams(64, [5, 4], [0.25, 0.75], 4),
    QParams(128, [5, 4], [0.25, 0.75], 4),
    QParams(256, [5, 4], [0.25, 0.75], 4),
    QParams(32, [5], [1], 4),
    QParams(64, [5], [1], 4),
    QParams(128, [5], [1], 4),
    QParams(256, [5], [1], 4),
    QParams(32, [6, 4], [0.1, 0.9], 4),
    QParams(64, [6, 4], [0.1, 0.9], 4),
    QParams(128, [6, 4], [0.1, 0.9], 4),
    QParams(256, [6, 4], [0.1, 0.9], 4),
    QParams(32, [6, 4], [0.25, 0.75], 4),
    QParams(64, [6, 4], [0.25, 0.75], 4),
    QParams(128, [6, 4], [0.25, 0.75], 4),
    QParams(256, [6, 4], [0.25, 0.75], 4),
    QParams(32, [6, 5], [0.1, 0.9], 4),
    QParams(64, [6, 5], [0.1, 0.9], 4),
    QParams(128, [6, 5], [0.1, 0.9], 4),
    QParams(256, [6, 5], [0.1, 0.9], 4),
    QParams(32, [6, 5], [0.25, 0.75], 4),
    QParams(64, [6, 5], [0.25, 0.75], 4),
    QParams(128, [6, 5], [0.25, 0.75], 4),
    QParams(256, [6, 5], [0.25, 0.75], 4),
    QParams(32, [6], [1], 4),
    QParams(64, [6], [1], 4),
    QParams(128, [6], [1], 4),
    QParams(256, [6], [1], 4),
    QParams(32, [8, 6], [0.1, 0.9], 4),
    QParams(64, [8, 6], [0.1, 0.9], 4),
    QParams(128, [8, 6], [0.1, 0.9], 4),
    QParams(256, [8, 6], [0.1, 0.9], 4),
    QParams(32, [8, 6], [0.25, 0.75], 4),
    QParams(64, [8, 6], [0.25, 0.75], 4),
    QParams(128, [8, 6], [0.25, 0.75], 4),
    QParams(256, [8, 6], [0.25, 0.75], 4),
    QParams(32, [8], [1], 4),
    QParams(64, [8], [1], 4),
    QParams(128, [8], [1], 4),
    QParams(256, [8], [1], 4),
