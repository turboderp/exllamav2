...
fp_gemm_half_q_half_kernel pick_gemm_half_q_half_kernel(const int m_count, bool r_weights, bool mul_r_weights)
{
    ...
    k = pick_gemm_half_q_half_kernel_1a(m_count, r_weights, mul_r_weights); if (k) return k;
    k = pick_gemm_half_q_half_kernel_1b(m_count, r_weights, mul_r_weights); if (k) return k;
    k = pick_gemm_half_q_half_kernel_2a(m_count, r_weights, mul_r_weights); if (k) return k;
    k = pick_gemm_half_q_half_kernel_2b(m_count, r_weights, mul_r_weights); if (k) return k;
    k = pick_gemm_half_q_half_kernel_3a(m_count, r_weights, mul_r_weights); if (k) return k;
    k = pick_gemm_half_q_half_kernel_3b(m_count, r_weights, mul_r_weights);        return k;
}
